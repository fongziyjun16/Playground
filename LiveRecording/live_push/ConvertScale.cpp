...
bool ConvertScale::Convert(unsigned char* srcImage, unsigned char* dstImage)
{
    ...
    av_image_fill_arrays(m_pAVFrameSrc->data, m_pAVFrameSrc->linesize, srcImage, m_srcPixelFormat, m_srcWidth, m_srcHeight, 1);
    av_image_fill_arrays(m_pAVFrameDes->data, m_pAVFrameDes->linesize, dstImage, m_dstPixelFormat, m_dstWidth, m_dstHeight, 1);
